...
db.restaurants.find({ $and: [ {"grades.score": { $gt: 70 }, "address.coord": { $lt: -65.754168 }, "cuisine": { $ne: "American " } }]}).pretty()
...
db.restaurants.find({"grades.score": { $gt: 70 }, "address.coord": { $lt: -65.754168 }, "cuisine": { $ne: "American " } }).pretty()
...
db.restaurants.find({"grades.score": {$lt: 10}},{restaurant_id: 1, name:1, borough:1,cuisine: 1,_id: 0}).pretty()
...
db.restaurants.find({name: {$regex: "^Wil"}, cuisine: {$nin: ["Chinese", "American "]}},{restaurant_id: 1, name:1, borough:1,cuisine: 1,_id: 0}).pretty()
...
db.restaurants.find({"grades.grade": "A", "grades.score": 11, "grades.date": new Date("2014-08-11T00:00:00Z")},{restaurant_id: 1, name:1, grades:1,_id: 0}).pretty()
...
db.restaurants.find({"address.coord.1": {$gt: 42, $lt: 52}},{restaurant_id: 1, name:1, address:1,_id: 0}).pretty()
